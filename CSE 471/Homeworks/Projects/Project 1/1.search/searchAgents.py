...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        """
        # is goal state once visits all 4 corners 
        visited = state[1]
...
def cornersHeuristic(state, problem):
    ...
    # check for available corners that have not been visited
    for corner in corners:
        if corner not in visited:
            toVisit.append(corner)
            
    # visit unvisited states and use manhattan to find the min distance to those states
